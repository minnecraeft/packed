...
public class VariantChestBlockEntityRenderer extends BlockEntityRenderer<VariantChestBlockEntity> {
    ...
    private static SpriteIdentifier createChestTextureId(Identifier path) {
        return new SpriteIdentifier(CHEST_ATLAS_TEXTURE, Packed.identifier("entity/chest/" + path.getPath()));
    }
    ...
    private static class ChestTextureSprites {
        ...
        public ChestTextureSprites(WoodVariant variant) {
            left = new SpriteIdentifier(CHEST_ATLAS_TEXTURE, Packed.identifier("entity/chest/" + variant.getIdentifier().getPath() + "/normal_left"));
            right = new SpriteIdentifier(CHEST_ATLAS_TEXTURE, Packed.identifier("entity/chest/" + variant.getIdentifier().getPath() + "/normal_right"));
            normal = new SpriteIdentifier(CHEST_ATLAS_TEXTURE, Packed.identifier("entity/chest/" + variant.getIdentifier().getPath() + "/normal"));
        }
    }
